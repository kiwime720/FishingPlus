...
const sectionContent = {
  spots: `<h2>낚시터 개선</h2><div id="map"></div>`,
  recommend: `
    <h2>낚시터 추천
      <button id="recWriteBtn" class="px-2 py-1 bg-green-500 text-white rounded float-right">글쓰기</button>
    </h2>
    <div id="recList"><p>추천글 목록이 여기에…</p></div>
  `,
  board: `
    <h2>자유게시판
